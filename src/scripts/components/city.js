...
Vcity.allCity = ['全部|quanbu|qb','北京|beijing|bj','上海|shanghai|sh', '重庆|chongqing|cq', 
   '云南|yunnan|yn', '浙江|zhejiang|zj', '广东|guangdong|gd', '天津|tianjin|tj', '广西|guangxi|gx', '贵州|guizhou|gz', '海南|hainan|hx','河北|hebei|hb',
    '河南|henan|hn', '黑龙江|heilongjiang|hlj','湖北|hubei|hb','湖南|hunan|hn','西藏|xizang|xz', '内蒙古|neimenggu|nmg', '吉林|jilin|jl', '江苏|jiangsu|js', '江西|jiangxi|jx',
    '辽宁|liaoning|ln', '宁夏|ningxia|nx', '青海|qinghai|qh', '山东|shandong|sd','山西|shanxi|sx', '陕西|shanxi|sx', '四川|sichuan|sc', '台湾|taiwan|tw', 
    '新疆|xijiang|xj', '香港|xianggang|xg', '甘肃|gansu|gs', '安徽|anhui|ah', '澳门|aomen|am', '福建|fujian|fj',];
...
Vcity.CitySelector.prototype = {
    ...
    inputEvent:function(){
        ...
        Vcity._m.on(this.input,'focus',function(){
            that.input.select();
            if(that.input.value == '') that.input.value = '全部';
        });
